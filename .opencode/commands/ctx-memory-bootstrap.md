...
If no arguments are provided, run `'/usr/local/bin/ctx' --repo-root '/Users/supporterino/repos/FreezerTracker' memory bootstrap` so CTX scans common files such as:
- `AGENTS.md`
- `CLAUDE.md`
- `CODEX.md`
